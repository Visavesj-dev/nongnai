  ...
  <div>
    <footer className="text-center">
      <p>
        <div>
          <h4>
            ปรึกษาอาการข้อปฏิบัติและพร้อมการดูแล ปรึกษาไม่มีค่าใช้จ่าย
            ปรึกษาวันนี้ดูแลจนหาย ยารักษาหนองใน1วัน ส่งทั่วไทยได้รับ Kerry Ems Flash
            ตกขาว คัน หนองไหล กลิ่นปลาเค็ม หูด รักษาได้ภาย 1 วัน
            <strong style={{ marginLeft: "15px", color: "red" }}>
              LineID : @316iwiba ใส่เครื่องหมาย @ ด้วยนะค่ะ
            </strong>
          </h4>
          <a
